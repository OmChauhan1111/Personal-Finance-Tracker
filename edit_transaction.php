...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE transactions SET amount = ?, category = ?, description = ?, transaction_date = ? WHERE id = ? AND user_id = ?");
        ...
        <form method="POST" class="transaction-form">
            ...
            <div class="form-group">
                ...
                <select name="category" id="category" required>
                    <!-- <option value="Income" <?php echo $transaction['category'] == 'Income' ? 'selected' : ''; ?>
                        >Income</option> -->
