...
$accountType = 'Business'; // व्यवसाय खाते के लिए फ़िक्स्ड नाम
...
// Fetch transactions for the business account
...
$netTotal = $totalIncome - $totalExpense; // शुद्ध राशि की गणना
?>
...
<body>
   <div class="btn-container">
    ...
    <div class="dashboard-container">
        ...
        <div>
            <a href="add_transaction.php?account_type=<?php echo urlencode($accountType); ?>" class="btn">Add Transaction</a>
        </div>
        ...
        <table class="transaction-table">
            ...
            <tr>
                ...
                <td>
                    <a href="edit_transaction.php?id=<?php echo $transaction['id']; ?>&account_type=<?php echo urlencode($accountType); ?>" class="btn edit-btn">Edit</a>
                </td>
                <td>
                    <form method="POST" action="delete_transaction.php" onsubmit="return confirm('Are you sure you want to delete this transaction?');">
        ...
        <div class="summary-container">
            ...
            <div class="summary-item">
                ...
                <p>Net Total: <?php echo number_format($netTotal, 2); ?></p>
            </div>
        </div>
    </div>
</body>
