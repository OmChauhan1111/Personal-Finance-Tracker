...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO business_transactions (user_id, amount, category, transaction_date, description, account_type) VALUES (?, ?, ?, ?, ?, ?)");
...
$stmt = $pdo->prepare("SELECT account_name FROM business_accounts WHERE user_id = ?");
$stmt->execute([$_SESSION['user_id']]);
